<x-user :$jumlahPesan :$files :$pesan :$pesanGrup>
    ...
    <div
        class="grid @if ($files->isEmpty()) place-items-center h-full w-full @else md:grid-cols-5 grid-cols-2 grid-cols-2 @endif  gap-y-[20px] gap-x-[16px]  min-[2368px]:grid-cols-6 p-5">
        @if ($files->isEmpty())
        ...
        <ul class="py-2 text-sm text-gray-700">
            ...
            <li>
                <button id="bSearch" class="block px-4 py-2 hover:bg-gray-100 flex items-center gap-3 w-full"
                    ...
                    data-modal-toggle="modalShareAnotherUser">
